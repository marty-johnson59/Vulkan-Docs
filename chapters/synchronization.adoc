...
ifdef::VK_HUAWEI_cluster_culling_shader[]
  ...
  * ename:VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT specifies the
    ...
    <<framebuffer-logicop, logic operations>>, <<renderpass-load-store-ops,
    subpass load and store operations>>, multisample resolve operations for
    framebuffer attachments with a color
...
ifdef::VK_EXT_blend_operation_advanced[]
    ...
    <<framebuffer-logicop, logic operations>>, or via certain
...
ifdef::VK_EXT_shader_tile_image[]
    <<renderpass-load-store-ops, subpass load operations>> or
    <<fragops-shader-tileimage-reads, fragment shader tile image reads>>.
endif::VK_EXT_shader_tile_image[]
    Such access occurs in the
...
ifdef::VK_VERSION_1_2,VK_KHR_depth_stencil_resolve[]
  ...
  * ename:VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT specifies write
    <<fragops-ds-state, depth or stencil operations>> in the
    ename:VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT_KHR or
    ename:VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR pipeline stages or
    via certain
ifndef::VK_EXT_shader_tile_image[]
    <<renderpass-load-store-ops, subpass load operations>>
endif::VK_EXT_shader_tile_image[]
ifdef::VK_EXT_shader_tile_image[]
    ...
    in the ename:VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT_KHR pipeline stage.
...
ifdef::VK_VERSION_1_2,VK_EXT_buffer_device_address,VK_KHR_buffer_device_address[]
  ...
  * ename:VK_ACCESS_COLOR_ATTACHMENT_READ_BIT specifies read access to a
    ...
    blending>>, <<framebuffer-logicop, logic operations>>, or certain
    <<renderpass-load-store-ops, subpass load operations>>.
ifdef::VK_EXT_blend_operation_advanced[]
...
ifdef::VK_VERSION_1_2,VK_KHR_depth_stencil_resolve[]
  ...
  * ename:VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT specifies read access
    ...
    depth or stencil operations>> or certain <<renderpass-load-store-ops,
...
To insert a memory dependency for explicit renderpass tile image
...
The following restrictions apply for such pipeline barriers:
  ...
  * The pipeline barriers can: only include memory barriers.
    ...
    used.
  * The stages in slink:VkMemoryBarrier2::srcStageMask and
    slink:VkMemoryBarrier2::dstStageMask are restricted to framebuffer space
    stages.
  * The access types in slink:VkMemoryBarrier2::srcAccessMask and
    slink:VkMemoryBarrier2::dstAccessMask are restricted to the following
    types: ename:VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT,
...
ifndef::VK_VERSION_1_1,VK_KHR_external_memory[]
  * [[VUID-VkBufferMemoryBarrier-buffer-07913]]
...
ifdef::VK_VERSION_1_1,VK_KHR_external_memory[]
  * [[VUID-VkBufferMemoryBarrier-buffer-07914]]
    If pname:buffer was created with a sharing mode of
...
ifndef::VK_KHR_synchronization2[]
ifndef::VK_VERSION_1_1,VK_KHR_external_memory[]
  * [[VUID-VkImageMemoryBarrier-image-07915]]
    If pname:image was created with a sharing mode of
    ename:VK_SHARING_MODE_CONCURRENT, pname:srcQueueFamilyIndex and
    pname:dstQueueFamilyIndex must: both be ename:VK_QUEUE_FAMILY_IGNORED
endif::VK_VERSION_1_1,VK_KHR_external_memory[]
ifdef::VK_VERSION_1_1,VK_KHR_external_memory[]
  * [[VUID-VkImageMemoryBarrier-image-07916]]
    If pname:image was created with a sharing mode of
    ename:VK_SHARING_MODE_CONCURRENT, at least one of
    pname:srcQueueFamilyIndex and pname:dstQueueFamilyIndex must: be
    ename:VK_QUEUE_FAMILY_IGNORED
